# Island Generator
This is a random Island Generator created to practice Agile development and OOP best practice. The island generator takes in various parameters (or none!), and then creates a randomized and reproducable island. Cities can also be added to the island map generator, and Dijkstra's algorithm was used to connect these cities
